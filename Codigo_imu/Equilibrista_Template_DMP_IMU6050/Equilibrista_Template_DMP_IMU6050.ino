...
MPU6050 mpu;
//*************************************** Ajustes ***************************************
double MotorVelocidadIzq = 0.9; //double MotorVelocidadIzq = 0.3;
double MotorVelocidadDer = 0.7; //double MotorVelocidadDer = 0.3;
...
void loop()
{
   if (input < 165 && input > 185){
    //Kp = 12;
    //Ki = 7;
    //Kd = 0.7;
    pid.SetOutputLimits(-195,195);
  }
  else if (input < 140 || input > 205){
